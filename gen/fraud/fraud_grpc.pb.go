...
const (
	FraudService_EvaluateTransfer_FullMethodName = "/fraud.FraudService/EvaluateTransfer"
)
...
type FraudServiceClient interface {
	EvaluateTransfer(ctx context.Context, in *EvaluateRequest, opts ...grpc.CallOption) (*EvaluateResponse, error)
}
...
func (c *fraudServiceClient) EvaluateTransfer(ctx context.Context, in *EvaluateRequest, opts ...grpc.CallOption) (*EvaluateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EvaluateResponse)
	err := c.cc.Invoke(ctx, FraudService_EvaluateTransfer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FraudServiceServer interface {
	EvaluateTransfer(context.Context, *EvaluateRequest) (*EvaluateResponse, error)
...
func (UnimplementedFraudServiceServer) EvaluateTransfer(context.Context, *EvaluateRequest) (*EvaluateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EvaluateTransfer not implemented")
}
...
func _FraudService_EvaluateTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EvaluateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FraudServiceServer).EvaluateTransfer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FraudService_EvaluateTransfer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FraudServiceServer).EvaluateTransfer(ctx, req.(*EvaluateRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _FraudService_EvaluateTransfer_Handler,
		},
	},
