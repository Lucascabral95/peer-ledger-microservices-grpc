...
const file_user_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\t\x12\f\n" +
	"\x04name\x18\x02 \x01(\t\x12\r\n" +
	"\x05email\x18\x03 \x01(\t\"$\n" +
	"\x11UserExistsRequest\x12\x0f\n" +
	"\auser_id\x18\x01 \x01(\t\"$\n" +
	"\x12UserExistsResponse\x12\x0e\n" +
	"\x06exists\x18\x01 \x01(\b\"@\n" +
	"\x0fRegisterRequest\x12\f\n" +
	"\x04name\x18\x01 \x01(\t\x12\r\n" +
	"\x05email\x18\x02 \x01(\t\x12\x10\n" +
	"\bpassword\x18\x03 \x01(\t\"@\n" +
	...
	"\adeleted\x18\x01 \x01(\b2\xb4\x02\n" +
	"\vUserService\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponse\x12?\n" +
	"\n" +
	"UserExists\x12\x17.user.UserExistsRequest\x1a\x18.user.UserExistsResponse\x129\n" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB&Z$github.com/peer-ledger/gen/user;userb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	4, // 2: user.UserService.Register:input_type -> user.RegisterRequest
	...
	3, // 6: user.UserService.UserExists:output_type -> user.UserExistsResponse
